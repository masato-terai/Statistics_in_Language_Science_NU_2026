...
　この講義は昨年2025度から担当しています（[2025年度の資料はこちら](https://masato-terai.github.io/stat_class_2025/)）。この講義内容は予告なく更新される可能性があります。
...
## 講義スケジュール
- Week 1：オリエンテーション、R(Studio)、Positronのインストールと操作、R Markdown
- Week 2：要約統計量
- Week 3：推測統計学
